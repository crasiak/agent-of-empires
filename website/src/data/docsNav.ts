...
export const docsNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Diff View", href: "/guides/diff-view/", description: "Review a session's changes from the TUI or the web dashboard." },
      ...
      { title: "Session Resume & Forking", href: "/guides/session-resume/", description: "Resume, fork, or import an agent conversation in a session." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Dashboard & Workspaces", href: "/guides/web/dashboard/", description: "The dashboard layout, session wizard, triage, settings, and profiles." },
