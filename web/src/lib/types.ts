...
export interface SessionResponse {
  ...
  favorited: boolean;
  /** Per-session highlight (`red` / `amber` / `green`), or null / undefined
   *  when unset. Tints the whole sidebar row and adds a solid color cue. Set
   *  via the sidebar context menu or `aoe session color <id> <color>`. */
  color?: string | null;
